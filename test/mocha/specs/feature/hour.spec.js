...
describe('App after loading', function () {
    ...
    describe('interacting with an hour', function () {
        ...
        describe('bar', function () {
            ...
            beforeEach(function () {
                this.$clickedHour = $('.js-hourBar').last();
                domEvent('click', this.$clickedHour[0]);
        ...
        describe('time text', function () {
            ...
            beforeEach(function () {
                this.$clickedHourText = $('.js-hourTime').last();
                domEvent('click', this.$clickedHourText[0]);
            });
        ...
        describe('temperature text', function () {
            ...
            beforeEach(function () {
                this.$clickedHourText = $('.js-hourTemperature').last();
                domEvent('click', this.$clickedHourText[0]);
            });
